        ...
        buttonReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(registr.this,"Enter email",Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(password)) {
                    Toast.makeText(registr.this,"Enter passsword",Toast.LENGTH_SHORT).show();
                    return;
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    Toast.makeText(registr.this, "Account created.",
                                    ...
                                    Toast.makeText(registr.this, "Authentication failed.",
                                            Toast.LENGTH_SHORT).show();
